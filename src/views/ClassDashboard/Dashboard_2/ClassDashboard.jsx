...
import HelpFooter from "../../../components/Footer/HelpFooter.jsx";
...
class ClassDashboard extends React.Component {
    ...
    render() {
        ...
        return (
            (participant_info.dashboard_sequence.indexOf(2) === -1 || participant_info.dashboard_sequence[0] === 2) ? (
                <>
